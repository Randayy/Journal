    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='EduHub.course')),
            ],
        ),
        migrations.CreateModel(
            name='Student',
            fields=[
                ...
                ('username', models.CharField(max_length=255)),
                ('password', models.CharField(default='123456', max_length=50, validators=[django.core.validators.MinLengthValidator(6, 'the field must contain at least 6 characters')])),
                ('group', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', to='EduHub.group')),
            ],
        ),
        migrations.CreateModel(
            name='Grade',
